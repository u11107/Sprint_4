...
public class DownListPageTest extends BasePageTest {
    ...
    public void checkPanel1() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion0);
    ...
    public void checkPanel2() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion1);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel3() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion2);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel4() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion3);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel5() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion4);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel6() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion5);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel7() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion6);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
    ...
    public void checkPanel8() {
        ...
        String actual = downListPage.gettingTextFromDropdownField(downListPage.accordion7);
        Assert.assertEquals("Текст в поле не верный", expected, actual);
    }
}
